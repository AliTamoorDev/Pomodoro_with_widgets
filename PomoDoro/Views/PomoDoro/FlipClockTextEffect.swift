...
struct FlipClockTextEffect: View {
    ...
    var body: some View {
        ...
        .onChange(of: value, initial: true) { oldValue, newValue in
            ...
            withAnimation(.easeOut(duration: animationDuration), completionCriteria: .logicallyComplete){
                rotation = -180
            } completion: {
                rotation = 0
                currentValue = value
    ...
    // Reusable View
    @ViewBuilder
    func NumberView(_ value: Int) -> some View {
